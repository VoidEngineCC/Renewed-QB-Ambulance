...
RegisterNetEvent("FailureCC:setVoiceStop")
AddEventHandler("FailureCC:setVoiceStop", function(data)
    MumbleSetActive(data)
    LocalPlayer.state.disableProximity = data
end)
...
function OnDeath()
    if not isDead then
        isDead = true
        TriggerEvent("FailureCC:setVoiceStop", false)
        ...
        if isDead then
            TriggerEvent("FailureCC:setVoiceStop", false)
            exports['pma-voice']:overrideProximityCheck(function(player) -- FailureCC modification, he hear any person
                return false
            end)
        ...
        if isDead or InLaststand then
            ...
            elseif InLaststand then
                ...
                if LaststandTime > Config.MinimumRevive then
                    ...
                    TriggerEvent('dynasty-deathscreen:die',LaststandTime)
                else
