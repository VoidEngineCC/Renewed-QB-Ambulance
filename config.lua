...
Config.AlwaysBleedChance = 40 -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(-817.43, -1236.82, 7.34),
    },
    ["duty"] = {
        [1] = vector3(-814.95, -1239.79, 7.34),
        [2] = vector3(1839.68, 3679.89, 34.28),
    },
    ["vehicle"] = {
        [1] = vector4(0,0, 0, 0),
        [2] = vector4(0,0, 0, 0),
    ...
    ["helicopter"] = {
        [1] = vector4(-791.05, -1191.87, 53.03, 52.54),
        [2] = vector4(0,0, 0, 0),
    },
    ["armory"] = {
        [1] = vector3(-820.28, -1242.9, 7.34),
        [2] = vector3(1822.21, 3664.98, 34.28),
    },
    ["roof"] = {
        [1] = vector3(-775.0, -1206.57, 51.15),
    },
    ["main"] = {
        [1] = vector3(-794.86, -1246.8, 7.34),
    },
    ["stash"] = {
        [1] = vector3(-821.49, -1239.65, 7.34),
        [2] = vector3(1840.78, 3683.08, 34.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(-801.0, -1227.66, 8.26, 139.97), taken = false, model = 1631638868},
        [2] = {coords = vector4(-797.09, -1231.01, 8.26, 138.56), taken = false, model = 1631638868},
        [3] = {coords = vector4(-800.14, -1234.79, 8.26, 320.4), taken = false, model = 2117668672},
        [4] = {coords = vector4(-804.09, -1231.34, 8.26, 313.22), taken = false, model = 2117668672},
        [5] = {coords = vector4(-806.68, -1229.13, 8.26, 312.59), taken = false, model = 2117668672},
        [6] = {coords = vector4(-809.52, -1226.88, 8.26, 317.65), taken = false, model = -1091386327},
        [7] = {coords = vector4(-812.28, -1224.61, 8.26, 318.29), taken = false, model = -1091386327},
        [8] = {coords = vector4(-805.44, -1223.92, 8.26, 135.86), taken = false, model = -1091386327},
	--- paleto
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(-813.05, -1230.37, 17.18, 94.81)},
        --[2] = {label = Lang:t('info.pb_hospital'), coords = vector4(1838.89, 3671.85, 34.28, 202.65)}
    }
}
